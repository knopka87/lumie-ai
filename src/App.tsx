...
export default function App() {
            ...
            onTranscription: (text, isFinal, role) => {
              ...
              if (isFinal && role === 'model') {
                ...
                setMessages(prev => {
                  ...
                  if (last && last.role === 'assistant' && last.content === cleanedText)
                    return prev;
                  return [...prev, aiMsg];
                });
              }
  ...
  const cleanAiResponse = (text: string) => {
    return text
      ...
      .replace(
        /I've registered the greeting|I'm composing a response|confirmed the language parameters|plan to use a casual|aim for clarity|I'll use the user's name|I'll refer to the memory|I'll focus on|I'll start by|I'll provide a|I'll explain the/gi,
        ''
      )
      .trim();
  };
      ...
      <div className="flex h-screen items-center justify-center bg-[#FDFCFB]">
        ...
        >
          ...
          <div className="space-y-3">
            {/* On HTTPS: Custom button with One Tap prompt */}
            {/* On HTTP (localhost): Show native Google button to avoid FedCM errors */}
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    <button
                      ...
                      className={cn(
                        'flex w-full items-center gap-4 rounded-2xl border-2 px-6 py-4 text-left transition-all',
                        voice === 'lumie'
                      ...
                      <div className="flex-1">
                        <div
                          className={cn(
                            ...
                            voice === 'lumie' ? 'text-orange-900' : 'text-gray-900'
                          )}
                        >
                          Lumie (Female)
                        </div>
                        <div
                          className={cn(
                            'text-[11px]',
                            voice === 'lumie' ? 'text-orange-600/70' : 'text-gray-400'
                          )}
                        >
                          Warm, empathetic, and cheerful voice
                        </div>
                      </div>
                      {voice === 'lumie' && <Check className="h-5 w-5 text-orange-500" />}
                    </button>
                    <button
                    ...
                    >
                      <div
                        className={cn(
                          'flex h-12 w-12 shrink-0 items-center justify-center rounded-full',
                          voice === 'leo' ? 'bg-orange-500 text-white' : 'bg-gray-100 text-gray-400'
                        )}
                      >
                        <span className="text-xl">👨</span>
                      </div>
                      <div className="flex-1">
                        <div
                          className={cn(
                            'mb-0.5 text-sm font-bold',
                            voice === 'leo' ? 'text-orange-900' : 'text-gray-900'
                          )}
                        >
                          Leo (Male)
                        </div>
                        <div
                          className={cn(
                            'text-[11px]',
                            voice === 'leo' ? 'text-orange-600/70' : 'text-gray-400'
                          )}
                        >
                          Warm, empathetic, and supportive voice
                        </div>
                      </div>
                      {voice === 'leo' && <Check className="h-5 w-5 text-orange-500" />}
                    </button>
                  </div>
                </div>
